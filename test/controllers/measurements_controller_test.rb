...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { fat_percentage: @measurement.fat_percentage, measured_on: @measurement.measured_on, weight: @measurement.weight } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { fat_percentage: @measurement.fat_percentage, measured_on: @measurement.measured_on, weight: @measurement.weight } }
